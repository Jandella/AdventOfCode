...
namespace _2021AdventOfCode
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Day10 d10 = new Day10();
            //Console.WriteLine("day 10 quiz 1: {0}", d10.Quiz1());
            //Console.WriteLine("day 10 quiz 2: {0}", d10.Quiz2());

            //Day11 d11 = new Day11();
            //Console.WriteLine("day 11 quiz 1: {0}", d11.Quiz1());
            //Console.WriteLine("day 11 quiz 2: {0}", d11.Quiz2());
            ...
            //Day13 d13 = new Day13();
            //stopWatch.Restart();
            //var day13quiz1 = d13.Quiz1();
            //stopWatch.Stop();
            //Console.WriteLine("day 13 quiz 1: {0} - elapsed time: {1}", day13quiz1, stopWatch.Elapsed);
            //stopWatch.Restart();
            //var day13quiz2 = d13.Quiz2();
            //stopWatch.Stop();
            //Console.WriteLine("day 13 quiz 2:");
            //Console.WriteLine(day13quiz2);
            //Console.WriteLine("day 13 quiz 2 elapsed time: {0}", stopWatch.Elapsed);
            ...
            //Day15 d15 = new Day15();
            //Console.WriteLine("day 15 quiz 1: {0}", d15.Quiz1());
            //Console.WriteLine("day 15 quiz 2: {0}", d15.Quiz2());

            //Day16 d16 = new Day16();
            //Console.WriteLine("day 16 quiz 1: {0}", d16.Quiz1());
            //Console.WriteLine("day 16 quiz 2: {0}", d16.Quiz2());

            //Day17 d17 = new Day17();
            //Console.WriteLine("day 17 quiz 1: {0}", d17.Quiz1());
            //Console.WriteLine("day 17 quiz 2: {0}", d17.Quiz2());
            Day18 d18 = new Day18();
            d18.Test();
            Console.WriteLine("day 17 quiz 1: {0}", d18.Quiz1());
            Console.WriteLine("day 17 quiz 2: {0}", d18.Quiz2());
